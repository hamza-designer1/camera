...
class UScriptStruct* FRenderRequestStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RenderRequestStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRenderRequestStruct, (UObject*)Z_Construct_UPackage__Script_CameraPlugin(), TEXT("RenderRequestStruct"));
	}
...
template<> CAMERAPLUGIN_API UScriptStruct* StaticStruct<FRenderRequestStruct>()
{
	...
	struct Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACaptureManager, ACaptureManager::StaticClass, TEXT("ACaptureManager"), &Z_Registration_Info_UClass_ACaptureManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACaptureManager), 704014558U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_3648979428(TEXT("/Script/CameraPlugin"),
		Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Altroverse_LA_Plugins_CameraPlugin_Source_CameraPlugin_Public_CaptureManager_h_Statics::ScriptStructInfo),
		nullptr, 0);
