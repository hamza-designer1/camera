...
class CAMERAPLUGIN_API ACaptureManager : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    // TSoftObjectPtr<ASceneCapture2D> CaptureComponent;


    UFUNCTION(BlueprintCallable, Category = "Resolution")
        void updateResolution(int newFrameW, int newFrameH);
